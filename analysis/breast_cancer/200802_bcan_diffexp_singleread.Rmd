...
regs.fp <- file.path(subdir,"200802_bcan_diffexp_tss_1kb_regs.bed")
```
...
Sys.time() - st
# output
cgout <- file.path(subdir,"200731_MCF10AMCF7MDAMB231_nanoNOMe_tss_diffexp_20kb_singleread_cpg_calls.txt.gz")
gcout <- file.path(subdir,"200731_MCF10AMCF7MDAMB231_nanoNOMe_tss_diffexp_20kb_singleread_gc_runs.txt.gz")
write_tsv(cgcalls,cgout)
write_tsv(gcruns,gcout)

summary(gcruns$distance)
summary(cgcalls$distance)
```
###########################################################
# EM clustering
###########################################################
...
pdf(file.path(plotdir,"200804_protregs_frac_distro.pdf"))
