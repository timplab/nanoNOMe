#!/bin/bash
rawdir=/mithril/Data/NGS/Raw/160405_TXGenemorph_NA12878
outdir=/mithril/Data/NGS/Aligned/160406_na12878cntrl/isac_analysis
logroot=$outdir/log
...
if [ "$1" == "fqtrim" ];then
  for fq in $(find $rawdir -name "NA12878*R1*.fastq.gz");do
    samp=$(basename "$fq")
    samp=${samp%%_R1*}
    echo $samp
